...
```{r, eval=TRUE}
rabbit::update(pipeline=stockPipeline, what="cv", value="lgocv")
rabbit::update(pipeline=stockPipeline, what="p", value="0.70")
rabbit::update(pipeline=stockPipeline, what="nfolds", value=20)
